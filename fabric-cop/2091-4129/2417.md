...
https://jenkins.hyperledger.org/job/fabric-cop-verify-x86_64/29/ : SUCCESS</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/10/2016, 11:43:08 AM<br><strong>UnmergedRevision</strong>: [d1320a5988636a3458d0ee3a032622c6cd5d0c85](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/d1320a5988636a3458d0ee3a032622c6cd5d0c85)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/10/2016, 4:26:54 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/10/2016, 11:09:35 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Gari Singh - gari.r.singh@gmail.com<br><strong>Approved</strong>: 11/11/2016, 4:22:42 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [api/error.go#L27](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/api/error.go#L27)<br><strong>Comment</strong>: <pre>I think I have reviewed and corrected it when this was in the fabric/ca branch... can we incorporate the suggestions?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/database_accessor.go#L17](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/database_accessor.go#L17)<br><strong>Comment</strong>: <pre>Let's use Golang standard file naming conventions. I don't know this got merged with an _. Can you please fix?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/database_accessor.go#L82](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/database_accessor.go#L82)<br><strong>Comment</strong>: <pre>Shall we name the file differently, to match the DBAccessor (rather than database_accessor) ?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/errors.go#L26](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/errors.go#L26)<br><strong>Comment</strong>: <pre>'N" for consistent capitalization at the beginning, please.</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L51](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L51)<br><strong>Comment</strong>: <pre>Register</pre><strong>Commenter</strong>: Keith Smith - keithsmithlfid@gmail.com<br><strong>CommentLine</strong>: [cli/server/register.go#L51](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L51)<br><strong>Comment</strong>: <pre>You must be kidding!  This is a debug message.  Why does this matter??</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L51](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L51)<br><strong>Comment</strong>: <pre>Keith, I am not entirely sure what gave you the (wrong) impression that I "must be kidding!". Even debug messages should be grammatically correct and well formatted.

That said, looking at the "grand scheme of things": this is the least important comment/suggestion made in the initial partial review of ours (way after the licensing/commit message, error checking, standard const/file names, etc.) - and it is not why we gave it a "-2" after careful examination. Will highly appreciate it, if you could prioritize/address the other comments as well.


---

p.s. I'm sorry, but I must say that I don't like the tone of your comment/response.

I am truly sorry for any inconvenience my review has caused. When I see issues, I post them (consistently), as after a while staring at the same code, I get used to it, and I tend to miss the "first impression" effect that I have when I read (new) code for the first time.

<amiably>
   This is just how my (limited) brain works.
</amiably></pre><strong>Commenter</strong>: Keith Smith - keithsmithlfid@gmail.com<br><strong>CommentLine</strong>: [cli/server/register.go#L51](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L51)<br><strong>Comment</strong>: <pre>Sorry Jonathan for any perceived tone. I was simply a truly surprised response and appreciate the time you spend reviewing.

WRT this comment, we will change the debug message "register request received" to "Register request received".  Does this mean that all debug messages should begin with uppercase?  Is this documented somewhere?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L67](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L67)<br><strong>Comment</strong>: <pre>Please remove</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L74](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L74)<br><strong>Comment</strong>: <pre>Any reason why we don't look at the returned error (and later on return "tok" which may be invalid?).

If there's a good reason, let's document. Otherwise, let's add the error checking.</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L76](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L76)<br><strong>Comment</strong>: <pre>Capitalization + maybe some context if/as it's for debugging?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L89](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L89)<br><strong>Comment</strong>: <pre>What's "hf" ?

Also, a non-boolean flag/var/const should probably not be called isRegistrar...</pre><strong>Commenter</strong>: Keith Smith - keithsmithlfid@gmail.com<br><strong>CommentLine</strong>: [cli/server/register.go#L89](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L89)<br><strong>Comment</strong>: <pre>"hf" stands for "Hyperledger Fabric"</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [cli/server/register.go#L89](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/cli/server/register.go#L89)<br><strong>Comment</strong>: <pre>Noted, thank you. Not sure if you would like it capitalized then (Like the HFC we talked about back in the day for Hyperledger Fabric Client)... but up to you.

I'd focus on the const/var name. Thanks.</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [lib/temporalSigner.go#L17](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/lib/temporalSigner.go#L17)<br><strong>Comment</strong>: <pre>1. Design, Design, Design:
Why do we keep on changing package names in every other check-in?
Can we please have a design document, listing out the proposed packages?

2. Also, let's use a standard Golang file naming convention. Not sure why we started camelcase naming in this instance ["temporalSigner.go"]</pre><strong>Commenter</strong>: Keith Smith - keithsmithlfid@gmail.com<br><strong>CommentLine</strong>: [lib/temporalSigner.go#L17](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/lib/temporalSigner.go#L17)<br><strong>Comment</strong>: <pre>Jonathan, this is an implementation of an API.  Why does it matter if the package names are moved?  The corresponding factory was changed to reference this new location and there is no difference from a user perspective.  BTW, the reason this was done was to flatten the directory structure since the APIs will be part of fabric and COP will have only a single implementation.  We also flattened the directory structure in some places to make it easier to avoid circular dependencies AND to get test coverage to report for the correct package.</pre><strong>Commenter</strong>: Saad Karim - skarim@us.ibm.com<br><strong>CommentLine</strong>: [lib/temporalSigner.go#L17](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/d1320a5988636a3458d0ee3a032622c6cd5d0c85/lib/temporalSigner.go#L17)<br><strong>Comment</strong>: <pre>Jonathon, I assume you are saying the filename should be all lowercase (temporalsigner.go). I don't think we want to use an underscore, right? This is what I found regarding file naming conventions in go: http://stackoverflow.com/questions/25161774/what-are-conventions-for-filenames-in-go</pre></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/11/2016, 1:57:22 PM<br><strong>UnmergedRevision</strong>: [ad141c532ae9c017a53a19181a43789e8fbc9178](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/ad141c532ae9c017a53a19181a43789e8fbc9178)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/11/2016, 2:11:18 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/10/2016, 11:09:35 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Gari Singh - gari.r.singh@gmail.com<br><strong>Approved</strong>: 11/11/2016, 4:22:42 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/11/2016, 2:57:17 PM<br><strong>UnmergedRevision</strong>: [f40cc5f5227846df7b44ff37362973dc62d5be2f](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/f40cc5f5227846df7b44ff37362973dc62d5be2f)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/11/2016, 3:06:44 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/10/2016, 11:09:35 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Keith Smith - keithsmithlfid@gmail.com<br><strong>Approved</strong>: 11/14/2016, 11:03:19 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Gari Singh - gari.r.singh@gmail.com<br><strong>Approved</strong>: 11/15/2016, 7:38:52 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [scripts/check_lint#L20](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/f40cc5f5227846df7b44ff37362973dc62d5be2f/scripts/check_lint#L20)<br><strong>Comment</strong>: <pre>lint -> golint</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [scripts/check_vet#L27](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/f40cc5f5227846df7b44ff37362973dc62d5be2f/scripts/check_vet#L27)<br><strong>Comment</strong>: <pre>go -> Go 

or 

"No 'go vet' problems found"</pre></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 10:33:07 AM<br><strong>UnmergedRevision</strong>: [e9ac50b8d9c809b93eef148336623e3df609a119](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/e9ac50b8d9c809b93eef148336623e3df609a119)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 10:41:36 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/10/2016, 11:09:35 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 5</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 10:58:08 AM<br><strong>UnmergedRevision</strong>: [abc49c37bfe6854b024916f895ec7ec0e91a0839](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/abc49c37bfe6854b024916f895ec7ec0e91a0839)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 11:04:55 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/10/2016, 11:09:35 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 6</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 11:06:32 AM<br><strong>UnmergedRevision</strong>: [2660b485b1525d5cbd06da49e14e8e4f8bd37343](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/2660b485b1525d5cbd06da49e14e8e4f8bd37343)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 11:27:04 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/10/2016, 11:09:35 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 7</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 11:30:34 AM<br><strong>UnmergedRevision</strong>: [e3aa054ae5e537fd4e3cbe521a91b7a129af52b8](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/e3aa054ae5e537fd4e3cbe521a91b7a129af52b8)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 11:57:38 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/15/2016, 2:56:11 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [lib/verifier.go#L32](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/e3aa054ae5e537fd4e3cbe521a91b7a129af52b8/lib/verifier.go#L32)<br><strong>Comment</strong>: <pre>I'm not sure whether you'd like to make the certificate public?
While we have a  'getMyCert()' getter method (which is not public?). 

Saad, please could you double-check/advise?</pre><strong>Commenter</strong>: Saad Karim - skarim@us.ibm.com<br><strong>CommentLine</strong>: [lib/verifier.go#L32](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/e3aa054ae5e537fd4e3cbe521a91b7a129af52b8/lib/verifier.go#L32)<br><strong>Comment</strong>: <pre>Good catch! It should have been public and we will address it.</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [lib/verifier.go#L55](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/e3aa054ae5e537fd4e3cbe521a91b7a129af52b8/lib/verifier.go#L55)<br><strong>Comment</strong>: <pre>V (as in the class/type/struct's name)</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [scripts/bash_profile#L158](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/e3aa054ae5e537fd4e3cbe521a91b7a129af52b8/scripts/bash_profile#L158)<br><strong>Comment</strong>: <pre>VERY NICE!</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [scripts/check_license#L3](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/e3aa054ae5e537fd4e3cbe521a91b7a129af52b8/scripts/check_license#L3)<br><strong>Comment</strong>: <pre>Go files

 or

 '*.go' files</pre></blockquote><h3>PatchSet Number: 8</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 2:58:59 PM<br><strong>UnmergedRevision</strong>: [bc16d5bfd0cbf66a917ae811b439ab18e922ab9a](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/bc16d5bfd0cbf66a917ae811b439ab18e922ab9a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 3:09:08 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 9</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 3:14:52 PM<br><strong>UnmergedRevision</strong>: [115b48f7d31466dc08be5435b6ea555ffa8717c9](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/115b48f7d31466dc08be5435b6ea555ffa8717c9)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 3:17:25 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 10</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Uploader</strong>: Saad Karim - skarim@us.ibm.com<br><strong>Created</strong>: 11/15/2016, 3:35:45 PM<br><strong>GitHubMergedRevision</strong>: [33fa279f71d1645f08293be467f5385eb191f0ce](https://github.com/hyperledger-gerrit-archive/fabric-cop/commit/33fa279f71d1645f08293be467f5385eb191f0ce)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/15/2016, 3:49:26 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 11/15/2016, 4:39:22 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Keith Smith - keithsmithlfid@gmail.com<br><strong>Approved</strong>: 11/15/2016, 4:41:05 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Gari Singh - gari.r.singh@gmail.com<br><strong>Approved</strong>: 11/15/2016, 5:48:42 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>MergedBy</strong>: Gari Singh<br><strong>Merged</strong>: 11/15/2016, 5:48:46 PM<br><br><h2>Comments</h2><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [lib/verifier.go#L62](https://github.com/hyperledger-gerrit-archive/fabric-cop/blob/33fa279f71d1645f08293be467f5385eb191f0ce/lib/verifier.go#L62)<br><strong>Comment</strong>: <pre>Now I'm not sure we need the getter, as it is public, but let's go ahead and revisit as we make more process (and see what's the best way).
