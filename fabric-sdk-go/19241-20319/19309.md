...
Logs: https://logs.hyperledger.org/production/vex-yul-hyp-jenkins-3/fabric-sdk-go-tests-merge-x86_64/517</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 2:44:22 PM<br><strong>UnmergedRevision</strong>: [ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 3:16:52 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/common/providers/core/provider.go#L43](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/common/providers/core/provider.go#L43)<br><strong>Comment</strong>: <pre>Couldn't this be done without changing the interface?</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/common/providers/core/provider.go#L43](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/common/providers/core/provider.go#L43)<br><strong>Comment</strong>: <pre>Any one who has reference to *x509.CertPool from previous function can play with cert pool, making it as not threadsafe.

Removed SetTLSCACertPool which can be used to replace whole cert pool and it is not being used anywhere as of now.</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/common/providers/core/provider.go#L43](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/common/providers/core/provider.go#L43)<br><strong>Comment</strong>: <pre>We could hide x509.CertPool behind e.g. core.CertPool that would expose the same public methods as x509.CertPool. Less friction for the users.</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/common/providers/core/provider.go#L43](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/common/providers/core/provider.go#L43)<br><strong>Comment</strong>: <pre>x509.Certpool is needed as it is for tls.Config

https://gerrit.hyperledger.org/r/#/c/19309/1/pkg/core/config/comm/comm.go#43</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/common/providers/core/provider.go#L116](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/common/providers/core/provider.go#L116)<br><strong>Comment</strong>: <pre>Is this really needed?</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>Couldn't we return here just *c.tlsCertPool, without introducing TLSCACerts? The lock is useful when calling this particular function, but the caller still has access to the pool, with or without the new structure.</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>I did that before, but has trouble at lot places to pass empty structs and all, which was mistaken as an actual cert pool. I can put it back if you think we should do that.</pre><strong>Commenter</strong>: Bob Stasyszyn - bob.stasyszyn@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1539](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/ee3f0cfd66613b01ccc6dfe1ee4b4ddfb4e90a1a/pkg/core/config/config.go#L1539)<br><strong>Comment</strong>: <pre>I'm not sure that this struct accomplishes much. It takes a copy of the cert pool but it doesn't make a deep copy so we're still exposed to some threading issues. I don't know if we can do much more than protect the TLSCACertPool method during modification of the pool and leave it up to the SDK user not to modify the pool directly.</pre></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 4:21:44 PM<br><strong>UnmergedRevision</strong>: [48759c889d4acd2b0cea8724b41fbaa20e67ca65](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/48759c889d4acd2b0cea8724b41fbaa20e67ca65)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 4:23:59 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: NO_CODE_CHANGE<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 4:23:48 PM<br><strong>UnmergedRevision</strong>: [50b285950301536fb231eea918ba8691ed382682](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/50b285950301536fb231eea918ba8691ed382682)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 4:36:54 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Troy Ronda - troy@troyronda.com<br><strong>Approved</strong>: 3/16/2018, 4:30:26 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: TRIVIAL_REBASE<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 4:36:16 PM<br><strong>UnmergedRevision</strong>: [b14f2f72a891b70fa8d0f596af45b63966c9820b](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/b14f2f72a891b70fa8d0f596af45b63966c9820b)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 5:30:51 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Divyank Katira - divyanktk@gmail.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>I'm not sure if this is thread-safe. If we return this, other go-routines could be reading this even while we are writing to it.

Maybe we need to return some sort of copy of this thread pool?</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>I reverted that change in previous commit, since it needed some kind of interface change.

Any suggestion on copying?</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>Maybe we need to have a separate function for updating a cert pool, e.g. in pkg/core, have it thread safe, and document that everyone has to use that one to add to the pool. We certainly need it.</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>Sure, will split this function to two,

1.) One to return cert pool
2.) another one to add to certpool

with RW lock</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>Does it belong to Config?</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>Yes</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1333](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/b14f2f72a891b70fa8d0f596af45b63966c9820b/pkg/core/config/config.go#L1333)<br><strong>Comment</strong>: <pre>Maybe for this push, lets keep it in config.

We have task open to split config between packages, then we can move this one out.</pre></blockquote><h3>PatchSet Number: 5</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 6:26:21 PM<br><strong>UnmergedRevision</strong>: [92158dbe4c38cd0e8821fb4d497292f2cf68aae7](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/92158dbe4c38cd0e8821fb4d497292f2cf68aae7)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 6:28:54 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 6</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 6:28:43 PM<br><strong>UnmergedRevision</strong>: [e82e28a0325cde886fcf60b84752f691b3a0974a](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/e82e28a0325cde886fcf60b84752f691b3a0974a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 6:30:44 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 7</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 6:30:33 PM<br><strong>UnmergedRevision</strong>: [9bf3c5d4495ba15eb50b04592e315e7b272b1e53](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/9bf3c5d4495ba15eb50b04592e315e7b272b1e53)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 6:44:04 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>Approved</strong>: 3/16/2018, 6:37:51 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 8</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 6:43:51 PM<br><strong>UnmergedRevision</strong>: [a70d0aff909f523f51fe2380e746f8bc16fcf54a](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/a70d0aff909f523f51fe2380e746f8bc16fcf54a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 6:47:21 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 9</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 6:51:18 PM<br><strong>UnmergedRevision</strong>: [5d47da5852107c1058cab5934253cfafbb729fae](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/5d47da5852107c1058cab5934253cfafbb729fae)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 7:55:16 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Troy Ronda - troy@troyronda.com<br><strong>Approved</strong>: 3/16/2018, 7:30:40 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Divyank Katira - divyanktk@gmail.com<br><strong>Approved</strong>: 3/16/2018, 7:27:18 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L217](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/5d47da5852107c1058cab5934253cfafbb729fae/pkg/core/config/config.go#L217)<br><strong>Comment</strong>: <pre>We should initialize c.tslCertPool here, with certs from config and ftom the system (if applicable) ....</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L217](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/5d47da5852107c1058cab5934253cfafbb729fae/pkg/core/config/config.go#L217)<br><strong>Comment</strong>: <pre>We decided not to maintain pool due to threadsafety challenges and we cannot even perform shallow copy on 'x509.CertPool'. Therefore we decided to maintain cert list instead.</pre><strong>Commenter</strong>: Troy Ronda - troy@troyronda.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L217](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/5d47da5852107c1058cab5934253cfafbb729fae/pkg/core/config/config.go#L217)<br><strong>Comment</strong>: <pre>yes we cannot initialize a cert pool but rather maintain a list, and create a new cert pool when needed.

this is due to CertPool not being an interface (tls seems to take a struct argument) and members of CertPool being unexported.</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1316](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/5d47da5852107c1058cab5934253cfafbb729fae/pkg/core/config/config.go#L1316)<br><strong>Comment</strong>: <pre>.... then return a copy of c.tlsCerts here. The code below should be used for initialization only.</pre><strong>Commenter</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1316](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/5d47da5852107c1058cab5934253cfafbb729fae/pkg/core/config/config.go#L1316)<br><strong>Comment</strong>: <pre>We need below code to crreate/update pool with new certs provided as an argument.</pre><strong>Commenter</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>CommentLine</strong>: [pkg/core/config/config.go#L1332](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/blob/5d47da5852107c1058cab5934253cfafbb729fae/pkg/core/config/config.go#L1332)<br><strong>Comment</strong>: <pre>maybe we can do this as a part of the changes above.</pre></blockquote><h3>PatchSet Number: 10</h3><blockquote><strong>Type</strong>: TRIVIAL_REBASE<br><strong>Author</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Uploader</strong>: Sudesh Shetty - sudesh.shetty@securekey.com<br><strong>Created</strong>: 3/16/2018, 8:55:54 PM<br><strong>GitHubMergedRevision</strong>: [c570198d48e61e2f45c6cc0f474ec69e6777df4a](https://github.com/hyperledger-gerrit-archive/fabric-sdk-go/commit/c570198d48e61e2f45c6cc0f474ec69e6777df4a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 3/16/2018, 10:08:49 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Troy Ronda - troy@troyronda.com<br><strong>Approved</strong>: 3/16/2018, 8:58:25 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>MergedBy</strong>: Troy Ronda<br><strong>Merged</strong>: 3/16/2018, 10:17:10 PM<br><br><strong>Approver</strong>: Aleksandar Likic - aleksandar.likic@securekey.com<br><strong>Approved</strong>: 3/16/2018, 9:02:48 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote>