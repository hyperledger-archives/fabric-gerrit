...
Let’s make this more formal. The slice allocation should not be on the mainline path.</pre><strong>Reviewer</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Reviewed</strong>: 5/22/2019, 8:01:38 PM<br><strong>Message</strong>: <pre>Patch Set 10:

(1 comment)

> Let’s make this more formal. The slice allocation should not be on
 > the mainline path.
...
Logs: https://logs.hyperledger.org/production/vex-yul-hyp-jenkins-3/fabric-merge-end-2-end-x86_64/5407</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/15/2019, 1:52:46 AM<br><strong>UnmergedRevision</strong>: [b78b1c0a3cc9009925fcac2c4e4f1db687cce384](https://github.com/hyperledger-gerrit-archive/fabric/commit/b78b1c0a3cc9009925fcac2c4e4f1db687cce384)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 2:02:37 AM<br><strong>Type</strong>: F1-VerifyBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 2:02:37 AM<br><strong>Type</strong>: F2-DocBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 2:45:15 AM<br><strong>Type</strong>: F3-IntegrationTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 10:08:05 AM<br><strong>Type</strong>: F3-UnitTest<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 5/15/2019, 4:26:39 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L21](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L21)<br><strong>Comment</strong>: <pre>either keep this a pointer and remove the comment,
or just make this not a pointer but remove the comment.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L21](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L21)<br><strong>Comment</strong>: <pre>okay</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L27](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L27)<br><strong>Comment</strong>: <pre>Was ChannelDemultiplexer meant to be an interface such that it would need this constructor for getting an instance?</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L42](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L42)<br><strong>Comment</strong>: <pre>no need for the once. Just return early if the m.closed is set.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L42](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L42)<br><strong>Comment</strong>: <pre>even then, there's no harm in setting the bool every time and iterating through an empty slice.

maintenance burden of a fast-exit is not worth it here. There shouldn't be nearly any cases where this will be on a hot path.

acquire the lock and do the deed.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L42](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L42)<br><strong>Comment</strong>: <pre>OK, then at least export this func() to an unexported method. 

The indentation makes it less appealing.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L48](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L48)<br><strong>Comment</strong>: <pre>I don't think so. All readers will eventually drain it.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L48](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L48)<br><strong>Comment</strong>: <pre>if we get in here at all, probably.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L66](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L66)<br><strong>Comment</strong>: <pre>I think this is a reasonable, misuse resistant change.

Otherwise it is possible to get and start waiting on a channel that will never have anything put into it.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L66](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L66)<br><strong>Comment</strong>: <pre>I agree</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L84](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux.go#L84)<br><strong>Comment</strong>: <pre>this is the key issue causing hangs in test cases.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L74](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux_test.go#L74)<br><strong>Comment</strong>: <pre>TODO: remove this</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L76](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux_test.go#L76)<br><strong>Comment</strong>: <pre>key question, should DeMultiplex block if any of the internal channels are full?</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L84](https://github.com/hyperledger-gerrit-archive/fabric/blob/b78b1c0a3cc9009925fcac2c4e4f1db687cce384/gossip/comm/demux_test.go#L84)<br><strong>Comment</strong>: <pre>If it should block, should it prevent close from occurring until the message is delivered?</pre></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/15/2019, 5:16:18 PM<br><strong>UnmergedRevision</strong>: [9b472cc6d68280b247962b50cd4b758e2fbbf6c2](https://github.com/hyperledger-gerrit-archive/fabric/commit/9b472cc6d68280b247962b50cd4b758e2fbbf6c2)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 5:23:36 PM<br><strong>Type</strong>: F1-VerifyBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 5:23:36 PM<br><strong>Type</strong>: F2-DocBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 6:02:39 PM<br><strong>Type</strong>: F3-IntegrationTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/15/2019, 5:52:49 PM<br><strong>Type</strong>: F3-UnitTest<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: TRIVIAL_REBASE<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/15/2019, 5:17:47 PM<br><strong>UnmergedRevision</strong>: [e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7](https://github.com/hyperledger-gerrit-archive/fabric/commit/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/17/2019, 9:21:26 AM<br><strong>Type</strong>: F1-VerifyBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/17/2019, 9:21:26 AM<br><strong>Type</strong>: F2-DocBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/17/2019, 10:00:24 AM<br><strong>Type</strong>: F3-IntegrationTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/17/2019, 9:50:33 AM<br><strong>Type</strong>: F3-UnitTest<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Matthew Sykes - sykesmat@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L27](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux.go#L27)<br><strong>Comment</strong>: <pre>thank you</pre><strong>Commenter</strong>: Matthew Sykes - sykesmat@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L51](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux.go#L51)<br><strong>Comment</strong>: <pre>Looks like this should be returning a receive only channel.

Also, why empty interface?</pre><strong>Commenter</strong>: Matthew Sykes - sykesmat@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L51](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux.go#L51)<br><strong>Comment</strong>: <pre>empty interface is because of MessageAcceptor; noted.</pre><strong>Commenter</strong>: Matthew Sykes - sykesmat@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L58](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux.go#L58)<br><strong>Comment</strong>: <pre>If this is intended to be a receive only channel, the method needs to return a receive only channel to prevent simple attempts to send to a closed channel and the associated panic or close the channel that is managed by this code.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L83](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux_test.go#L83)<br><strong>Comment</strong>: <pre>really hoping for commentary and discussion on this issue.</pre><strong>Commenter</strong>: Matthew Sykes - sykesmat@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L83](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux_test.go#L83)<br><strong>Comment</strong>: <pre>It will right now but it doesn't have to. Close is a one-shot so we can copy the slice to get the chan references with the lock held and then drop it when closing.

Perhaps make that change when updating the return signature from AddChannel?</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L83](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux_test.go#L83)<br><strong>Comment</strong>: <pre>I don't understand, we're blocked on acquiring the lock in close().

We can't get the lock to make a copy in close.

If we make the copy in DeMultiplex, we can still call close while sending, which will panic.


I'm not seeing the solution here. If I add a per chan lock, I still need to communicate that it's closed. If I add a status chan, I ought to be able to select on it and the data chan to short circuit the behavior.</pre><strong>Commenter</strong>: Matthew Sykes - sykesmat@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L83](https://github.com/hyperledger-gerrit-archive/fabric/blob/e6fdb56d69ef4e2b2f3b3ca2e0b2672eae5e0ce7/gossip/comm/demux_test.go#L83)<br><strong>Comment</strong>: <pre>On the lock/close, yes, of course you're right. We'd still be racing with close and it would be pointless. This is why I don't try to write code for at least two hours for every day I'm out of the office.

Not a lot of good options. How about using a closed channel? Instead of checking m.closed in Add and DeMultiplex, use selects.

For the constructor, we'd need to create an unbuffered closed chan. The first time close is called, we need to close the closed chan before acquiring the lock that's used to serialize the channels. The serialization here should not be done with the lock that covers the demux channels.

For add, while holding the lock that covers the demux channels, do a non-blocking receive from the close channel. If receive completes, the close channel is closed meaning the demux is closed. We can simply return a new closed empty interface channel like you do today; if the channel is not closed, the demux is still open and we fall into the default block to append the channel.

For demux, while holding the read lock that covers the demux channels, instead of a blind send, use a select where one of the cases is receiving from the close chan and the other is sending. If close is called, the close chan will be closed and it will break out of the select causing the lock to be dropped.

Since demux has the rlock on channels, close won't be able to modify the slice of channels until it acquires the lock for write. I *believe* that would serialize what's here and get us out of the blocking send.

I'm still a few hours away from being able to write code so, this may all be wrong.</pre></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/20/2019, 7:22:56 PM<br><strong>UnmergedRevision</strong>: [191a2f1ad363989ad9a6642fc650d02215d62d58](https://github.com/hyperledger-gerrit-archive/fabric/commit/191a2f1ad363989ad9a6642fc650d02215d62d58)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/20/2019, 7:28:09 PM<br><strong>Type</strong>: F1-VerifyBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/20/2019, 7:28:09 PM<br><strong>Type</strong>: F2-DocBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/20/2019, 8:08:51 PM<br><strong>Type</strong>: F3-IntegrationTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/20/2019, 7:56:15 PM<br><strong>Type</strong>: F3-UnitTest<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 5</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/21/2019, 6:58:52 PM<br><strong>UnmergedRevision</strong>: [844d80e70574f325c4ab38f839961f1851731194](https://github.com/hyperledger-gerrit-archive/fabric/commit/844d80e70574f325c4ab38f839961f1851731194)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 7:06:10 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 6</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/21/2019, 7:04:40 PM<br><strong>UnmergedRevision</strong>: [c23bc18f715bbc9c9bfe55800fe1b2b9787dd266](https://github.com/hyperledger-gerrit-archive/fabric/commit/c23bc18f715bbc9c9bfe55800fe1b2b9787dd266)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 7:14:47 PM<br><strong>Type</strong>: F1-VerifyBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 7:14:47 PM<br><strong>Type</strong>: F2-DocBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 8:05:10 PM<br><strong>Type</strong>: F3-IntegrationTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 7:42:48 PM<br><strong>Type</strong>: F3-UnitTest<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Swetha Repakula - srepaku@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L72](https://github.com/hyperledger-gerrit-archive/fabric/blob/c23bc18f715bbc9c9bfe55800fe1b2b9787dd266/gossip/comm/demux.go#L72)<br><strong>Comment</strong>: <pre>I would write out bidirectional if you are going to make this channel creation outside of the struct creation on the next line.</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L72](https://github.com/hyperledger-gerrit-archive/fabric/blob/c23bc18f715bbc9c9bfe55800fe1b2b9787dd266/gossip/comm/demux.go#L72)<br><strong>Comment</strong>: <pre>It has to be outside of the struct, as it is converted during the struct construction.</pre></blockquote><h3>PatchSet Number: 7</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Uploader</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>Created</strong>: 5/21/2019, 8:21:47 PM<br><strong>UnmergedRevision</strong>: [1661627853593ce38e1304efd444083aab90f7c6](https://github.com/hyperledger-gerrit-archive/fabric/commit/1661627853593ce38e1304efd444083aab90f7c6)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 8:32:22 PM<br><strong>Type</strong>: F1-VerifyBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 8:32:22 PM<br><strong>Type</strong>: F2-DocBuild<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 9:14:47 PM<br><strong>Type</strong>: F3-IntegrationTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 5/21/2019, 9:03:31 PM<br><strong>Type</strong>: F3-UnitTest<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 5/22/2019, 2:36:13 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Ronen Schaffer - ronen.schaffer@ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L55](https://github.com/hyperledger-gerrit-archive/fabric/blob/1661627853593ce38e1304efd444083aab90f7c6/gossip/comm/demux.go#L55)<br><strong>Comment</strong>: <pre>`m.lock.Unlock()` is called anyway.
Using `defer m.lock.Unlock()` right after the lock can be considered</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L87](https://github.com/hyperledger-gerrit-archive/fabric/blob/1661627853593ce38e1304efd444083aab90f7c6/gossip/comm/demux.go#L87)<br><strong>Comment</strong>: <pre>looks like you need to unlock here?</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L87](https://github.com/hyperledger-gerrit-archive/fabric/blob/1661627853593ce38e1304efd444083aab90f7c6/gossip/comm/demux.go#L87)<br><strong>Comment</strong>: <pre>wow, yeesh, thankful for reviews. adding a test.
added a test with debug here.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux.go#L91](https://github.com/hyperledger-gerrit-archive/fabric/blob/1661627853593ce38e1304efd444083aab90f7c6/gossip/comm/demux.go#L91)<br><strong>Comment</strong>: <pre>seems like we always call deMuxInProgress.Done() once no matter through which execution path we exit this function.

So perhaps just do defer demuxInProgess.Done() 
after this line, and then remove the below calls to Done() ?</pre><strong>Commenter</strong>: Ronen Schaffer - ronen.schaffer@ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L37](https://github.com/hyperledger-gerrit-archive/fabric/blob/1661627853593ce38e1304efd444083aab90f7c6/gossip/comm/demux_test.go#L37)<br><strong>Comment</strong>: <pre>Shouldn't %d be used instead of %q?</pre><strong>Commenter</strong>: Morgan Bauer - mbauer@us.ibm.com<br><strong>CommentLine</strong>: [gossip/comm/demux_test.go#L37](https://github.com/hyperledger-gerrit-archive/fabric/blob/1661627853593ce38e1304efd444083aab90f7c6/gossip/comm/demux_test.go#L37)<br><strong>Comment</strong>: <pre>I like getting what I'm printing in quotes, but it looks like  that fails here and returns strange output, done.


=== RUN   TestChannelDeMultiplexer_EvenOddChannels
--- FAIL: TestChannelDeMultiplexer_EvenOddChannels (0.00s)
    demux_test.go:39: filter didn't work, or something got pulled out of the channel buffers, evens:'\n', odds:'\t'
FAIL
exit status 1
