...
Nice, thanks :)</pre><strong>Reviewer</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>Reviewed</strong>: 10/18/2017, 10:29:22 AM<br><strong>Message</strong>: <pre>Patch Set 5: Code-Review+2</pre><strong>Reviewer</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>Reviewed</strong>: 10/18/2017, 10:29:29 AM<br><strong>Message</strong>: <pre>Change has been successfully merged by Binh Nguyen</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Uploader</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Created</strong>: 9/21/2017, 6:12:13 AM<br><strong>UnmergedRevision</strong>: [d250c276470ee2d2d22fd7deafeb26acab48a1d7](https://github.com/hyperledger-gerrit-archive/fabric/commit/d250c276470ee2d2d22fd7deafeb26acab48a1d7)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 9/21/2017, 8:53:05 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 9/30/2017, 8:35:56 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Maria Dubovitskaya - maria.dubovitskaya@gmail.com<br><strong>Approved</strong>: 9/22/2017, 4:54:17 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [idemix/idemix_test.go#L128](https://github.com/hyperledger-gerrit-archive/fabric/blob/d250c276470ee2d2d22fd7deafeb26acab48a1d7/idemix/idemix_test.go#L128)<br><strong>Comment</strong>: <pre>you can just do: "assert.NoError(t, err)</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L15](https://github.com/hyperledger-gerrit-archive/fabric/blob/d250c276470ee2d2d22fd7deafeb26acab48a1d7/idemix/nymsignature.go#L15)<br><strong>Comment</strong>: <pre>what is the reason of making this a static method? why isn't this an instance method of the signing identity?</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L15](https://github.com/hyperledger-gerrit-archive/fabric/blob/d250c276470ee2d2d22fd7deafeb26acab48a1d7/idemix/nymsignature.go#L15)<br><strong>Comment</strong>: <pre>I think it would be cleaner keeping the actual crypto code in the idemix package, and just calling it from the msp. That's also how we're making the "associationProof" and verify signatures etc, just calls to the idemix package.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L15](https://github.com/hyperledger-gerrit-archive/fabric/blob/d250c276470ee2d2d22fd7deafeb26acab48a1d7/idemix/nymsignature.go#L15)<br><strong>Comment</strong>: <pre>All right.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [msp/idemixmsp.go#L256](https://github.com/hyperledger-gerrit-archive/fabric/blob/d250c276470ee2d2d22fd7deafeb26acab48a1d7/msp/idemixmsp.go#L256)<br><strong>Comment</strong>: <pre>This is code duplication. 
Why not do:
...
Either way - please provide *detailed* comments in the struct definition that this corresponds to a proof that the Nym belongs to the MSP reference in the struct.</pre></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Uploader</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Created</strong>: 10/2/2017, 4:50:28 AM<br><strong>UnmergedRevision</strong>: [eec9a1fbce21f1982b5b52688cdbaa234526f436](https://github.com/hyperledger-gerrit-archive/fabric/commit/eec9a1fbce21f1982b5b52688cdbaa234526f436)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 10/2/2017, 6:47:52 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>Approved</strong>: 10/6/2017, 10:58:13 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L10](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L10)<br><strong>Comment</strong>: <pre>why would we want to keep this separate instead of in Fabric repo? I thought keeping it in Fabric would allow others from the community to update if necessary; otherwise we would have to work through your repo or fork again.</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L10](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L10)<br><strong>Comment</strong>: <pre>We thought it was nicer to vendor this code as it isn't new code but an external library that we simply repackaged. We don't expect many updates to this code, other than the occasional update to sync it with the original code, and urgent fixes could be done on the vendored code in fabric. However, we are also open to the idea of simply putting the code directly into fabric (rather than vendoring it).</pre><strong>Commenter</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L10](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L10)<br><strong>Comment</strong>: <pre>Since we have to repackage, we should put it in Fabric instead of another level of indirection. I see that the source is also Apache-2, so there shouldn't be any issues in bringing the code into our repo.</pre><strong>Commenter</strong>: Maria Dubovitskaya - maria.dubovitskaya@gmail.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L10](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L10)<br><strong>Comment</strong>: <pre>OK, we will do it in a separate commit (created a jira issue for that: FAB-6666)</pre><strong>Commenter</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L15](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L15)<br><strong>Comment</strong>: <pre>Perhaps you could add some comments describing the correspondence between computed values and schnorr signature/zk proof components ? It would make easier to follow :)</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L15](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L15)<br><strong>Comment</strong>: <pre>Done</pre><strong>Commenter</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L16](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L16)<br><strong>Comment</strong>: <pre>Can it be that this is nil?</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L16](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L16)<br><strong>Comment</strong>: <pre>added a check to handle nil inputs</pre><strong>Commenter</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L18](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L18)<br><strong>Comment</strong>: <pre>can it be that this is nil?</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [idemix/nymsignature.go#L18](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/idemix/nymsignature.go#L18)<br><strong>Comment</strong>: <pre>added a check to handle nil inputs</pre><strong>Commenter</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>CommentLine</strong>: [msp/idemixmsp.go#L251](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/msp/idemixmsp.go#L251)<br><strong>Comment</strong>: <pre>SInce this check is done at msp setup, it can be removed from here, correct?</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [msp/idemixmsp.go#L251](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/msp/idemixmsp.go#L251)<br><strong>Comment</strong>: <pre>Nicely spotted, especially when it's not part of the change set. 

Why was this here in the first place?</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [msp/idemixmsp.go#L251](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/msp/idemixmsp.go#L251)<br><strong>Comment</strong>: <pre>Good point, I removed it here.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [msp/idemixmsp.go#L251](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/msp/idemixmsp.go#L251)<br><strong>Comment</strong>: <pre>Can you tell why it was here in the 1st place?</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [msp/idemixmsp.go#L251](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/msp/idemixmsp.go#L251)<br><strong>Comment</strong>: <pre>I guess because it is important for validate() that the ipk is checked at some point and I didn't realize that it is always already checked in setup.</pre><strong>Commenter</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>CommentLine</strong>: [protos/msp/identities.proto#L36](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/protos/msp/identities.proto#L36)<br><strong>Comment</strong>: <pre>NymY</pre><strong>Commenter</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>CommentLine</strong>: [protos/msp/identities.proto#L36](https://github.com/hyperledger-gerrit-archive/fabric/blob/eec9a1fbce21f1982b5b52688cdbaa234526f436/protos/msp/identities.proto#L36)<br><strong>Comment</strong>: <pre>Done</pre></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Uploader</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Created</strong>: 10/16/2017, 8:53:09 AM<br><strong>UnmergedRevision</strong>: [c783e2c05ca8624d91302dfe1bc4c3ee2140a786](https://github.com/hyperledger-gerrit-archive/fabric/commit/c783e2c05ca8624d91302dfe1bc4c3ee2140a786)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 10/16/2017, 10:13:30 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: TRIVIAL_REBASE<br><strong>Author</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Uploader</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Created</strong>: 10/16/2017, 10:34:07 AM<br><strong>UnmergedRevision</strong>: [67d34c2b8039547b7167a08a262ab16bc2e810a4](https://github.com/hyperledger-gerrit-archive/fabric/commit/67d34c2b8039547b7167a08a262ab16bc2e810a4)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 10/16/2017, 11:47:13 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>Approved</strong>: 10/17/2017, 10:13:09 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 5</h3><blockquote><strong>Type</strong>: TRIVIAL_REBASE<br><strong>Author</strong>: Manu Drijvers - mdr@zurich.ibm.com<br><strong>Uploader</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Created</strong>: 10/17/2017, 10:18:45 AM<br><strong>GitHubMergedRevision</strong>: [df735ebe2de2e84c637836fcb61a9823b05b60ae](https://github.com/hyperledger-gerrit-archive/fabric/commit/df735ebe2de2e84c637836fcb61a9823b05b60ae)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 10/17/2017, 11:24:29 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>Approved</strong>: 10/18/2017, 10:29:22 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>MergedBy</strong>: Binh Nguyen<br><strong>Merged</strong>: 10/18/2017, 10:29:29 AM<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 10/17/2017, 10:22:46 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Angelo De Caro - adc@zurich.ibm.com<br><strong>Approved</strong>: 10/18/2017, 5:45:09 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>Approved</strong>: 10/18/2017, 4:32:14 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Maria Dubovitskaya - maria.dubovitskaya@gmail.com<br><strong>Approved</strong>: 10/17/2017, 6:42:39 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote>