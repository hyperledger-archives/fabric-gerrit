...
Well I (and Kostas) have been trying to educate people in code reviews whenever we saw...</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/10/2017, 4:42:00 PM<br><strong>UnmergedRevision</strong>: [084cbc6cbf5c0757fb420e6b4882c2566284d90a](https://github.com/hyperledger-gerrit-archive/fabric/commit/084cbc6cbf5c0757fb420e6b4882c2566284d90a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/10/2017, 5:10:37 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/10/2017, 5:19:27 PM<br><strong>UnmergedRevision</strong>: [da94eb5f095b0b53a20b2082756b47f084904559](https://github.com/hyperledger-gerrit-archive/fabric/commit/da94eb5f095b0b53a20b2082756b47f084904559)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/10/2017, 5:48:18 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 4/10/2017, 6:01:04 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/common/validation/fullflow_test.go#L87](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/core/common/validation/fullflow_test.go#L87)<br><strong>Comment</strong>: <pre>no need for the ( )</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/common/validation/fullflow_test.go#L233](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/core/common/validation/fullflow_test.go#L233)<br><strong>Comment</strong>: <pre>no need for the ( )</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/common/validation/fullflow_test.go#L256](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/core/common/validation/fullflow_test.go#L256)<br><strong>Comment</strong>: <pre>this needs to be = and not :=</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/common/validation/msgvalidation.go#L135](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/core/common/validation/msgvalidation.go#L135)<br><strong>Comment</strong>: <pre>why is this the design, though?
an application is interested in an event on the context of a channel, no?
Why does this need to be channel-agnostic? 
Are we not making an un-necessary security hole here? (because, it means that a client can register to events on blocks for channels its organization isn't a member of)</pre><strong>Commenter</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>CommentLine</strong>: [core/common/validation/msgvalidation.go#L135](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/core/common/validation/msgvalidation.go#L135)<br><strong>Comment</strong>: <pre>As explained in the JIRA (FAB-1738) channel-specific events is the next step, it has wide-ranging implications so it's scoped for post-v1.0.

A peer is not allowed to join a channel that its organization is not part of. So using the channel MSPs to validate the incoming registration request's identity is well within the security realm.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L101](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/handler.go#L101)<br><strong>Comment</strong>: <pre>the ( ) aren't necessary</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L102](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/handler.go#L102)<br><strong>Comment</strong>: <pre>can you also please add the error to the error message? it can be useful.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L118](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/handler.go#L118)<br><strong>Comment</strong>: <pre>can you fix this typo too please?</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L41](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/producer.go#L41)<br><strong>Comment</strong>: <pre>why do we need these \n\n ? These things confuse log parsing frameworks that are used for logging aggregation.</pre><strong>Commenter</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L41](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/producer.go#L41)<br><strong>Comment</strong>: <pre>Done. forgot to clean up debug statements</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L53](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/producer.go#L53)<br><strong>Comment</strong>: <pre>same</pre><strong>Commenter</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L53](https://github.com/hyperledger-gerrit-archive/fabric/blob/da94eb5f095b0b53a20b2082756b47f084904559/events/producer/producer.go#L53)<br><strong>Comment</strong>: <pre>Done. forgot to clean up debug statements</pre></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/10/2017, 8:37:22 PM<br><strong>UnmergedRevision</strong>: [124d19a05cddfe050f90bbce4928e21c828b5f33](https://github.com/hyperledger-gerrit-archive/fabric/commit/124d19a05cddfe050f90bbce4928e21c828b5f33)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/10/2017, 9:08:24 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/10/2017, 9:51:18 PM<br><strong>UnmergedRevision</strong>: [042ff07e33ab2f239b7fae025a72145ae99cc7e1](https://github.com/hyperledger-gerrit-archive/fabric/commit/042ff07e33ab2f239b7fae025a72145ae99cc7e1)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/10/2017, 10:38:27 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 5</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/11/2017, 12:17:49 AM<br><strong>UnmergedRevision</strong>: [16e724bfe5f8e839356b71f9a93b9f8668f066bb](https://github.com/hyperledger-gerrit-archive/fabric/commit/16e724bfe5f8e839356b71f9a93b9f8668f066bb)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/11/2017, 12:41:29 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 6</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/11/2017, 12:18:48 AM<br><strong>UnmergedRevision</strong>: [53c585bfd08ae6ba9a1b227fbc4a569de5421521](https://github.com/hyperledger-gerrit-archive/fabric/commit/53c585bfd08ae6ba9a1b227fbc4a569de5421521)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/11/2017, 1:32:35 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>Approved</strong>: 4/11/2017, 6:28:00 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>CommentLine</strong>: [core/common/validation/msgvalidation.go#L130](https://github.com/hyperledger-gerrit-archive/fabric/blob/53c585bfd08ae6ba9a1b227fbc4a569de5421521/core/common/validation/msgvalidation.go#L130)<br><strong>Comment</strong>: <pre>As documented [FAB-2088].
The implementation here exposes a big security problem that if a channel can verify the listener, the listener will get all events from all channels, which we certainly don't want. I think instead of open up security problem, we should for 1.0 restrict to the same org as the peer and only check the local MSP unless we can manage to do more.

@Ale and Elli please weigh in.</pre><strong>Commenter</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>CommentLine</strong>: [core/common/validation/msgvalidation.go#L149](https://github.com/hyperledger-gerrit-archive/fabric/blob/53c585bfd08ae6ba9a1b227fbc4a569de5421521/core/common/validation/msgvalidation.go#L149)<br><strong>Comment</strong>: <pre>Instead of moving forward like this, would it not be easier to trigger 
CheckPolicyBySignedData of PolicyChecker included in core/policy/policy.go to deserialize and check validity of the creator and its signature against channel's policy and/or local msp members?</pre><strong>Commenter</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>CommentLine</strong>: [core/common/validation/msgvalidation.go#L167](https://github.com/hyperledger-gerrit-archive/fabric/blob/53c585bfd08ae6ba9a1b227fbc4a569de5421521/core/common/validation/msgvalidation.go#L167)<br><strong>Comment</strong>: <pre>since very likely that the event listener is a member of the same org as the peer, I think we should do this first before spinning through the channels as above.</pre></blockquote><h3>PatchSet Number: 7</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/17/2017, 11:10:37 PM<br><strong>UnmergedRevision</strong>: [73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718](https://github.com/hyperledger-gerrit-archive/fabric/commit/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/18/2017, 12:22:27 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>Approved</strong>: 4/18/2017, 2:52:36 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 4/18/2017, 1:37:39 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/consumer/consumer.go#L74](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/consumer/consumer.go#L74)<br><strong>Comment</strong>: <pre>fmt.Errorf() -> errors.New()</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/consumer/consumer.go#L74](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/consumer/consumer.go#L74)<br><strong>Comment</strong>: <pre>also while you're at it- errors must start with a lowercase.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/consumer/consumer.go#L79](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/consumer/consumer.go#L79)<br><strong>Comment</strong>: <pre>same here</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/consumer/consumer.go#L84](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/consumer/consumer.go#L84)<br><strong>Comment</strong>: <pre>and here</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L104](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/producer/handler.go#L104)<br><strong>Comment</strong>: <pre>fmt.Errorf() -> errors.New()</pre><strong>Commenter</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L161](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/producer/handler.go#L161)<br><strong>Comment</strong>: <pre>So here one could leverage policyChecker. Examples of how to use that is in https://gerrit.hyperledger.org/r/#/c/7671/7/core/scc/lccc/lccc.go lines 489-495, and lines 552 and 556 where method checkPolicywithSignedData should be used instead and under mgmt.Members policy. 
We can also take on updating this part for the merge not to delay.</pre><strong>Commenter</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L161](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/producer/handler.go#L161)<br><strong>Comment</strong>: <pre>hi Elli, I actually did attempt to use the PolicyChecker interface per your earlier comment and the implementation from the peer package, unfortunately this results in a circular dependency that I described in the commit message. It can be taken care of with code refactoring but I felt right now the checking is done with local MSP principles only without involving the custom policies so it's best to target the MSP APIs directly instead of going through the PolicyChecker interface.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L182](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/producer/handler.go#L182)<br><strong>Comment</strong>: <pre>1) Maybe do the check before the policy checking?
   This way, if the signature is not valid, we didn't check policy in vain? 
...
Regarding the 2nd option - @Jim - is there some kind of information that the client knows about the peer for sure? for example- maybe, the root CA cert of its org?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/producer_test.go#L2](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/events/producer/producer_test.go#L2)<br><strong>Comment</strong>: <pre>2017</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [protos/utils/txutils.go#L277](https://github.com/hyperledger-gerrit-archive/fabric/blob/73a6c1a4d21ce73fc33e3d83e9a95d50f3b65718/protos/utils/txutils.go#L277)<br><strong>Comment</strong>: <pre>fmt.Errorf() -> errors.New()</pre></blockquote><h3>PatchSet Number: 8</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/18/2017, 3:23:28 PM<br><strong>UnmergedRevision</strong>: [15b7fd8e45c84afe9e0135652e63b398f950a69c](https://github.com/hyperledger-gerrit-archive/fabric/commit/15b7fd8e45c84afe9e0135652e63b398f950a69c)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/18/2017, 5:03:02 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 4/18/2017, 3:51:42 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 9</h3><blockquote><strong>Type</strong>: TRIVIAL_REBASE<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/18/2017, 5:05:41 PM<br><strong>UnmergedRevision</strong>: [10715eb9816eb242e4b1b36c59c86cc282bfd41d](https://github.com/hyperledger-gerrit-archive/fabric/commit/10715eb9816eb242e4b1b36c59c86cc282bfd41d)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/18/2017, 6:20:53 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 10</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Uploader</strong>: Jim Zhang - jim_the_matrix@hotmail.com<br><strong>Created</strong>: 4/19/2017, 12:50:57 AM<br><strong>GitHubMergedRevision</strong>: [3870bcfba70de19ae1a2c5d757d8634e97e57839](https://github.com/hyperledger-gerrit-archive/fabric/commit/3870bcfba70de19ae1a2c5d757d8634e97e57839)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 4/19/2017, 1:58:24 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Binh Nguyen - binh1010010110@gmail.com<br><strong>Approved</strong>: 4/19/2017, 8:58:24 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>MergedBy</strong>: Binh Nguyen<br><strong>Merged</strong>: 4/19/2017, 8:58:29 AM<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 4/19/2017, 2:24:10 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/consumer/consumer.go#L80](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/consumer/consumer.go#L80)<br><strong>Comment</strong>: <pre>Could</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/consumer/consumer.go#L85](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/consumer/consumer.go#L85)<br><strong>Comment</strong>: <pre>Could</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L44](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L44)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L49](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L49)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L60](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L60)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L64](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L64)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L68](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L68)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L73](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L73)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L83](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L83)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L87](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L87)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L91](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L91)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L95](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L95)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/eventhelper.go#L99](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/eventhelper.go#L99)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/events.go#L213](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/events.go#L213)<br><strong>Comment</strong>: <pre>Yes, that's nice. Begin with a capital.</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/events.go#L222](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/events.go#L222)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L112](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/handler.go#L112)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L117](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/handler.go#L117)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L135](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/handler.go#L135)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/handler.go#L135](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/handler.go#L135)<br><strong>Comment</strong>: <pre>I'd change this to "sending" instead.</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L54](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/producer.go#L54)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L64](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/producer.go#L64)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre><strong>Commenter</strong>: Jonathan Levi (HACERA) - jonathan@hacera.com<br><strong>CommentLine</strong>: [events/producer/producer.go#L70](https://github.com/hyperledger-gerrit-archive/fabric/blob/3870bcfba70de19ae1a2c5d757d8634e97e57839/events/producer/producer.go#L70)<br><strong>Comment</strong>: <pre>Why are you lower-casing these?</pre></blockquote>