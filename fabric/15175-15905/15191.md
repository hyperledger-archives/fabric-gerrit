...
abandoning due to lack of activity</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Jeffery Garratt - garratt.jeff@gmail.com<br><strong>Uploader</strong>: Jeffery Garratt - garratt.jeff@gmail.com<br><strong>Created</strong>: 11/3/2017, 10:15:17 PM<br><strong>UnmergedRevision</strong>: [0415025731a96a162805cb112d8f48accce5dde2](https://github.com/hyperledger-gerrit-archive/fabric/commit/0415025731a96a162805cb112d8f48accce5dde2)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 11/3/2017, 11:36:45 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [core/scc/cscc/configure.go#L244](https://github.com/hyperledger-gerrit-archive/fabric/blob/0415025731a96a162805cb112d8f48accce5dde2/core/scc/cscc/configure.go#L244)<br><strong>Comment</strong>: <pre>Just as a point of correctness, we probably do need a new proto message, as this API should return the Resources config tree as well as the Channel Config tree.

Also note here how we are calling peer.NewReousrceServiceSupport() directly, which essentially re-injects the singleton that the ResourceServiceSupport was supposed to cure.  Although not a fundamental problem of the system chaincode protocol, the implementation of system chaincode as a singleton which is not constructed with context makes preventing the singleton injection challenging.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/scc/cscc/configure.go#L244](https://github.com/hyperledger-gerrit-archive/fabric/blob/0415025731a96a162805cb112d8f48accce5dde2/core/scc/cscc/configure.go#L244)<br><strong>Comment</strong>: <pre>he can just put it in the Init(), and then it will be injected once.

Though, I'm sure Jeff is aware of that and he only assembled this quickly to prove a point.</pre></blockquote>