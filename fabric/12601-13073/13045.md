...
Or if consensus is to use workerpool given all the thought and work that has gone into it, that's fine too.</pre><strong>Reviewer</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Reviewed</strong>: 10/6/2017, 4:21:45 AM<br><strong>Message</strong>: <pre>Abandoned</pre><h1>PatchSets</h1><h3>PatchSet Number: 1</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/31/2017, 9:44:11 AM<br><strong>UnmergedRevision</strong>: [02f3a218a5143094ed18cf1b740697f93866f747](https://github.com/hyperledger-gerrit-archive/fabric/commit/02f3a218a5143094ed18cf1b740697f93866f747)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/31/2017, 10:16:00 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/31/2017, 10:37:10 AM<br><strong>UnmergedRevision</strong>: [57777ee67817cb55621b4de52336decfdbc9bebf](https://github.com/hyperledger-gerrit-archive/fabric/commit/57777ee67817cb55621b4de52336decfdbc9bebf)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/31/2017, 11:58:08 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Baohua Yang - yangbaohua@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L40](https://github.com/hyperledger-gerrit-archive/fabric/blob/57777ee67817cb55621b4de52336decfdbc9bebf/common/workers/worker.go#L40)<br><strong>Comment</strong>: <pre>It would be better if we can add any docstring/comments for those packages and funcs.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L40](https://github.com/hyperledger-gerrit-archive/fabric/blob/57777ee67817cb55621b4de52336decfdbc9bebf/common/workers/worker.go#L40)<br><strong>Comment</strong>: <pre>Very good point, thank Baohua. I've added comments - see the next drop.</pre></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 9/1/2017, 6:05:32 AM<br><strong>UnmergedRevision</strong>: [b5b2fc46a00024b61e4ece738737b427a9ed2577](https://github.com/hyperledger-gerrit-archive/fabric/commit/b5b2fc46a00024b61e4ece738737b427a9ed2577)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 9/1/2017, 7:41:07 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>Approved</strong>: 9/10/2017, 1:31:53 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L17](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L17)<br><strong>Comment</strong>: <pre>Maybe we do not have a good convention established, but I would have assumed this to be "common/workers".</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L17](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L17)<br><strong>Comment</strong>: <pre>Thx, Done</pre><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L75](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L75)<br><strong>Comment</strong>: <pre>I'm a little skeptical of this buffered channel approach.  I think it complicates things considerably by requiring the ability to resize the buffers.

Instead, I would propose the following scheme:

 Simply have a single go routine which is responsible for enqueueing work.  This should not be the same go routine which will read results.  The worker go routines may now simply read from this unbuffered channel, and return normally, no resizing required.

Here is it written up as a go playground example:

https://play.golang.org/p/PDCo6sCgUh

Note especially that there is no casting or opaque parameters required, because the caller may simply write to a channel which is created and accessible in the closure.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L75](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L75)<br><strong>Comment</strong>: <pre>Thx, Jason. The current design wanted to achieve asynchronous enqueue behaviour together with no goroutine creation. I think I've found a decent compromise:
 - remove buffered channels
 - expose a function to enqueue a slice of work
 - have that function run in its own goroutine (to achieve non-blocking semantics)

This way we only create exactly 1 extra goroutine for each enqueue request and do away with buffered channels.

Wdyt?</pre><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L94](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L94)<br><strong>Comment</strong>: <pre>Could you use:

  logger.Panicf

please?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L94](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L94)<br><strong>Comment</strong>: <pre>Done, thx!</pre><strong>Commenter</strong>: Srinivasan Muralidharan - srinivasan.muralidharan99@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L124](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L124)<br><strong>Comment</strong>: <pre>Now that this is made a reusable workerpool implementation we cannot assume same protection as the original "validator" use case that inspired this package. There is the danger of work and results being accessed when it is being modified here and need to be protected with locks (or sync/atomic).</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L124](https://github.com/hyperledger-gerrit-archive/fabric/blob/b5b2fc46a00024b61e4ece738737b427a9ed2577/common/workers/worker.go#L124)<br><strong>Comment</strong>: <pre>Yup, I've changed the implementation quite significantly, pls have a look again! Thx!</pre></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 9/21/2017, 12:14:11 PM<br><strong>UnmergedRevision</strong>: [43d12c744afb9bfb5f7541bec32e1a0914fce0d6](https://github.com/hyperledger-gerrit-archive/fabric/commit/43d12c744afb9bfb5f7541bec32e1a0914fce0d6)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 9/21/2017, 1:46:49 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L70](https://github.com/hyperledger-gerrit-archive/fabric/blob/43d12c744afb9bfb5f7541bec32e1a0914fce0d6/common/workers/worker.go#L70)<br><strong>Comment</strong>: <pre>Overall I like the new approach better, however, from a calling perspective, it seems simpler to me to have a blocking call to enqueue work that the caller will generally spawn a go routine to invoke.

Really there is no reason that both cannot be supported.  Maybe:
...
with a single unit of work?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L66](https://github.com/hyperledger-gerrit-archive/fabric/blob/3db9900c55192c1e643d1acbf8af5e579f28f6e8/common/workers/worker.go#L66)<br><strong>Comment</strong>: <pre>That's a pretty good idea, I'll do that. Thx!</pre></blockquote><h3>PatchSet Number: 6</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 9/25/2017, 11:14:43 AM<br><strong>UnmergedRevision</strong>: [1946fd99b5f8f55095a1938ca28ab25550240d9d](https://github.com/hyperledger-gerrit-archive/fabric/commit/1946fd99b5f8f55095a1938ca28ab25550240d9d)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 9/25/2017, 11:40:50 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 7</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 9/25/2017, 11:38:54 AM<br><strong>UnmergedRevision</strong>: [93a000fb62f09060dae49a1fb5e693dcde449041](https://github.com/hyperledger-gerrit-archive/fabric/commit/93a000fb62f09060dae49a1fb5e693dcde449041)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 9/25/2017, 1:07:55 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>Approved</strong>: 9/25/2017, 3:08:26 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L24](https://github.com/hyperledger-gerrit-archive/fabric/blob/93a000fb62f09060dae49a1fb5e693dcde449041/common/workers/worker.go#L24)<br><strong>Comment</strong>: <pre>Should probably remove the 'Slice' word from all these definitions/comments now?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/worker.go#L24](https://github.com/hyperledger-gerrit-archive/fabric/blob/93a000fb62f09060dae49a1fb5e693dcde449041/common/workers/worker.go#L24)<br><strong>Comment</strong>: <pre>Ouch, yes, you're right of course, sorry I didn't notice</pre></blockquote><h3>PatchSet Number: 8</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 9/25/2017, 4:23:45 PM<br><strong>UnmergedRevision</strong>: [d4308a9e0220023c4ef6d28808d02b9a2b07991e](https://github.com/hyperledger-gerrit-archive/fabric/commit/d4308a9e0220023c4ef6d28808d02b9a2b07991e)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 9/25/2017, 5:50:03 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L21](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L21)<br><strong>Comment</strong>: <pre>Could you separate this out into a different test or separate the two halves of this test with the

 t.Run("NoWorkers", func(t *testing.T) {
    ...
 }

 t.Run("GoodWorkers", func(t *testing.T) {
    ...
 }

pattern?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L21](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L21)<br><strong>Comment</strong>: <pre>Thanks, I've split the test into two separate tests.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L27](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L27)<br><strong>Comment</strong>: <pre>what's the purpose of this?</pre><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L27](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L27)<br><strong>Comment</strong>: <pre>Presumably this is an attempt to emulate:

 make([]func(), 0, 10)

? Without the '[:0]' the slice would contain 10 zero value, then the for loop would append 10 new functions to it?</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L27](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L27)<br><strong>Comment</strong>: <pre>why not simply either initialize a nil slice with
var workSlice []func

or initialize a 10 lengthed slice and then instead of append, just write into the slice with the index?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L27](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L27)<br><strong>Comment</strong>: <pre>Right, I was trying to use the append built-in in a way that wouldn't require reallocations. I'll set with the index instead if you think that the syntax is awkward. Thx</pre><strong>Commenter</strong>: Jason Yellick - jyellick@us.ibm.com<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L51](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L51)<br><strong>Comment</strong>: <pre>Could you use:

 assert.Panics(...)

instead here?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [common/workers/workers_test.go#L51](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4308a9e0220023c4ef6d28808d02b9a2b07991e/common/workers/workers_test.go#L51)<br><strong>Comment</strong>: <pre>Oh, absolutely, I didn't know that such function existed. Thx!</pre></blockquote><h3>PatchSet Number: 9</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 10/2/2017, 5:24:50 AM<br><strong>UnmergedRevision</strong>: [8f19d510630b45f1d40b26b0f088f5958f4948e6](https://github.com/hyperledger-gerrit-archive/fabric/commit/8f19d510630b45f1d40b26b0f088f5958f4948e6)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 10/2/2017, 7:34:34 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Greg Haskins - gregory.haskins@gmail.com<br><strong>Approved</strong>: 10/2/2017, 11:49:39 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><strong>Approver</strong>: Kostas Christidis - kostas@gmail.com<br><strong>Approved</strong>: 10/2/2017, 11:25:04 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: -1<br><br><h2>Comments</h2><strong>Commenter</strong>: Kostas Christidis - kostas@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L24](https://github.com/hyperledger-gerrit-archive/fabric/blob/8f19d510630b45f1d40b26b0f088f5958f4948e6/common/workers/worker.go#L24)<br><strong>Comment</strong>: <pre>I disagree with the inclusion of this method to the interface.

In general, libraries providing asynchronous APIs is an anti-pattern. Truth be told, the gravest offest is when the library _only_ offers asynchronous APIs, which is something that you do not do here. But the fact of the matter remains that you should just offer the synchronous API and let the caller handle the rest. (i.e. `go foo.AssignWorkSync()`)</pre><strong>Commenter</strong>: Kostas Christidis - kostas@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L77](https://github.com/hyperledger-gerrit-archive/fabric/blob/8f19d510630b45f1d40b26b0f088f5958f4948e6/common/workers/worker.go#L77)<br><strong>Comment</strong>: <pre>`Debugf` (same for all the debugging statements in this method).

When testing locally I suggest adjusting the verbosity of the logger to DEBUG to make sure that the debugging statements are formatted properly. (In the orderer package we usually have an `init` function in the `_test.go` doing just that.)</pre><strong>Commenter</strong>: Kostas Christidis - kostas@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L80](https://github.com/hyperledger-gerrit-archive/fabric/blob/8f19d510630b45f1d40b26b0f088f5958f4948e6/common/workers/worker.go#L80)<br><strong>Comment</strong>: <pre>You could keep the declaration scoped to the if statement (`if work, ok := <-gw.work; ok`), but the best approach is probably declaring variables `work` and `ok` at the top of the method, so that memory for them doesn't have to be allocated every time the loop is executed.</pre><strong>Commenter</strong>: Kostas Christidis - kostas@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L80](https://github.com/hyperledger-gerrit-archive/fabric/blob/8f19d510630b45f1d40b26b0f088f5958f4948e6/common/workers/worker.go#L80)<br><strong>Comment</strong>: <pre>A nit, but if you're pushing a `workItem` (line 68), shouldn't you be pulling a `workItem` here as well?</pre><strong>Commenter</strong>: Kostas Christidis - kostas@gmail.com<br><strong>CommentLine</strong>: [common/workers/worker.go#L87](https://github.com/hyperledger-gerrit-archive/fabric/blob/8f19d510630b45f1d40b26b0f088f5958f4948e6/common/workers/worker.go#L87)<br><strong>Comment</strong>: <pre>Can you please add a test that exercises this path?</pre></blockquote>