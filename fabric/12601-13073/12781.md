...
We must stop proliferating the peer CLI</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [/COMMIT_MSG#L30](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba//COMMIT_MSG#L30)<br><strong>Comment</strong>: <pre>Thx. I wish I had known this requirement earlier, though: I've already spent some time developing the change set AND customers have requested ways of supplying transient material through the CLI for debugging purposes so I'm gonna have to ask on their behalf that this change set please be let in - it's small anyway</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L72](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/encshim/encshim.go#L72)<br><strong>Comment</strong>: <pre>worth to do a check if ent is nil in the rest of the methods and return error if so.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L72](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/encshim/encshim.go#L72)<br><strong>Comment</strong>: <pre>Good point, thx Yacov. I'll fix it.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/interfaces.go#L9](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/encshim/interfaces.go#L9)<br><strong>Comment</strong>: <pre>can you please put some comments?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/interfaces.go#L9](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/encshim/interfaces.go#L9)<br><strong>Comment</strong>: <pre>whoops - absolutely. Thx</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L33](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/entities.go#L33)<br><strong>Comment</strong>: <pre>please remove this</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L33](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/entities.go#L33)<br><strong>Comment</strong>: <pre>Done - thx</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L68](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/entities.go#L68)<br><strong>Comment</strong>: <pre>can you explain what is being done here?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L68](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/entities.go#L68)<br><strong>Comment</strong>: <pre>ah, yes, I've added a comment - thx</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L124](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/entities.go#L124)<br><strong>Comment</strong>: <pre>and this</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L124](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/entities.go#L124)<br><strong>Comment</strong>: <pre>good catch, thx</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/interfaces.go#L1](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/interfaces.go#L1)<br><strong>Comment</strong>: <pre>can you comment on these?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/interfaces.go#L1](https://github.com/hyperledger-gerrit-archive/fabric/blob/e1993bd33ca708d127c04b42e9ddda0bd06ca6ba/core/chaincode/shim/ext/entities/interfaces.go#L1)<br><strong>Comment</strong>: <pre>Yup, done</pre></blockquote><h3>PatchSet Number: 2</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/25/2017, 10:56:02 AM<br><strong>UnmergedRevision</strong>: [326b3e3f856d2e9827fb6ddf1675079c24c7fee8](https://github.com/hyperledger-gerrit-archive/fabric/commit/326b3e3f856d2e9827fb6ddf1675079c24c7fee8)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/25/2017, 1:51:02 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: -1<br><br></blockquote><h3>PatchSet Number: 3</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/25/2017, 11:41:52 AM<br><strong>UnmergedRevision</strong>: [3332ce205b0e6ccf061a94b9431d3f04e9b4a66a](https://github.com/hyperledger-gerrit-archive/fabric/commit/3332ce205b0e6ccf061a94b9431d3f04e9b4a66a)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/25/2017, 1:58:14 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br></blockquote><h3>PatchSet Number: 4</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/25/2017, 4:05:45 PM<br><strong>UnmergedRevision</strong>: [3868154bcc563ab6574acab6344032a3061e91d2](https://github.com/hyperledger-gerrit-archive/fabric/commit/3868154bcc563ab6574acab6344032a3061e91d2)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/25/2017, 5:28:18 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L32](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L32)<br><strong>Comment</strong>: <pre>I wonder why you need this struct if the key is un-exported.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L32](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L32)<br><strong>Comment</strong>: <pre>I encountered a use-case where encshim was used by some other code, and it was helpful to have this error bubble up so that we could test using a typecast. Do you mind if I leave it?</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L32](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L32)<br><strong>Comment</strong>: <pre>no, i don't</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L32](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L32)<br><strong>Comment</strong>: <pre>thx, done</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L49](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L49)<br><strong>Comment</strong>: <pre>what if ciphertext is not nil but just an empty slice? Is this possible? Perhaps do len(ciphertext) instead?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L49](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L49)<br><strong>Comment</strong>: <pre>good call - I'll test with len(). Thx</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L60](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L60)<br><strong>Comment</strong>: <pre>how about "nil entity, With should have been called"?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/encshim/encshim.go#L60](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/encshim/encshim.go#L60)<br><strong>Comment</strong>: <pre>Good call, changing it</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L13](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L13)<br><strong>Comment</strong>: <pre>can you fix the imports please? :)</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L13](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L13)<br><strong>Comment</strong>: <pre>Done! My IDE has added that empty line and for some reason goimports doesn't remove it..</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L79](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L79)<br><strong>Comment</strong>: <pre>but the check here checks this.Private, not this.Symmetric().

I'm confused.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L79](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L79)<br><strong>Comment</strong>: <pre>Ah, I think the condition we're testing is 

"if the key is an asymmetric one and we have the private instance" -> so that we can get the public instance

but the BCCSP code is structure in a way that Private() returns true when we have the private key of an asymmetric keypair, so calling private is sufficient. Does that make sense?</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L79](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L79)<br><strong>Comment</strong>: <pre>So basically you just want to compare only the public key, right?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L79](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L79)<br><strong>Comment</strong>: <pre>Exactly - if the keys are asymmetric, we compare the public version.</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L106](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L106)<br><strong>Comment</strong>: <pre>else is redundant here, but your choice.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities.go#L106](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities.go#L106)<br><strong>Comment</strong>: <pre>thx, changing</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities_test.go#L12](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities_test.go#L12)<br><strong>Comment</strong>: <pre>can you please fix the imports?</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/entities_test.go#L12](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/entities_test.go#L12)<br><strong>Comment</strong>: <pre>done - thx</pre><strong>Commenter</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/testutils.go#L12](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/testutils.go#L12)<br><strong>Comment</strong>: <pre>here too please</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/testutils.go#L12](https://github.com/hyperledger-gerrit-archive/fabric/blob/3868154bcc563ab6574acab6344032a3061e91d2/core/chaincode/shim/ext/entities/testutils.go#L12)<br><strong>Comment</strong>: <pre>done, thx</pre></blockquote><h3>PatchSet Number: 5</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/26/2017, 3:23:14 AM<br><strong>UnmergedRevision</strong>: [d4264f0cee91b3193f5df79da52cca372bc3f693](https://github.com/hyperledger-gerrit-archive/fabric/commit/d4264f0cee91b3193f5df79da52cca372bc3f693)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/26/2017, 8:00:13 AM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><h2>Comments</h2><strong>Commenter</strong>: Angelo De Caro - adc@zurich.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/testutils.go#L28](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4264f0cee91b3193f5df79da52cca372bc3f693/core/chaincode/shim/ext/entities/testutils.go#L28)<br><strong>Comment</strong>: <pre>Please, avoid to use this generic opts. Use the one that specify also the key length.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/testutils.go#L28](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4264f0cee91b3193f5df79da52cca372bc3f693/core/chaincode/shim/ext/entities/testutils.go#L28)<br><strong>Comment</strong>: <pre>This is a function that is meant for testing only - is it okay if we use generic options in test?</pre><strong>Commenter</strong>: Angelo De Caro - adc@zurich.ibm.com<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/testutils.go#L28](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4264f0cee91b3193f5df79da52cca372bc3f693/core/chaincode/shim/ext/entities/testutils.go#L28)<br><strong>Comment</strong>: <pre>Remove it, please. That generic options will be deprecated.</pre><strong>Commenter</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>CommentLine</strong>: [core/chaincode/shim/ext/entities/testutils.go#L28](https://github.com/hyperledger-gerrit-archive/fabric/blob/d4264f0cee91b3193f5df79da52cca372bc3f693/core/chaincode/shim/ext/entities/testutils.go#L28)<br><strong>Comment</strong>: <pre>Sure, I will. Please remove them and mark them as deprecated in bccsp (or create a JIRA so that someone will take care of it), otherwise I see no way for users of the BCCSP to not make this mistake. Thx!</pre></blockquote><h3>PatchSet Number: 6</h3><blockquote><strong>Type</strong>: REWORK<br><strong>Author</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Uploader</strong>: Alessandro Sorniotti - ale.linux@sopit.net<br><strong>Created</strong>: 8/27/2017, 6:43:10 AM<br><strong>GitHubMergedRevision</strong>: [d0a1064bfc7b3f67860bff795c763bdb7833ed8e](https://github.com/hyperledger-gerrit-archive/fabric/commit/d0a1064bfc7b3f67860bff795c763bdb7833ed8e)<br><br><strong>Approver</strong>: Hyperledger Jobbuilder - jobbuilder@jenkins.hyperledger.org<br><strong>Approved</strong>: 8/27/2017, 12:31:35 PM<br><strong>Type</strong>: Verified<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Yacov Manevich - yacovm@il.ibm.com<br><strong>Approved</strong>: 8/27/2017, 10:35:00 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Angelo De Caro - adc@zurich.ibm.com<br><strong>Approved</strong>: 8/27/2017, 10:54:07 PM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>Approver</strong>: Gari Singh - gari.r.singh@gmail.com<br><strong>Approved</strong>: 8/29/2017, 6:10:41 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br><strong>MergedBy</strong>: Gari Singh<br><strong>Merged</strong>: 8/29/2017, 6:10:46 AM<br><br><strong>Approver</strong>: Elli Androulaki - lli@zurich.ibm.com<br><strong>Approved</strong>: 8/29/2017, 4:37:57 AM<br><strong>Type</strong>: Code-Review<br><strong>Value</strong>: 1<br><br></blockquote>